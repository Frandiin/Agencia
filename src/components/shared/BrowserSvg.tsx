...
const BrowserSvg = forwardRef<SVGSVGElement>((_props, ref) => (
  ...
  >
    ...
    {/* Image inner lines (content) */}
    <line
      className="draw-content-img-line"
      x1="235"
      y1="85"
      x2="280"
      y2="85"
